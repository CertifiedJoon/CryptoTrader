...
while True:
    try:
        ...
        if start_time < now < end_time - datetime.timedelta(seconds=10) and not bought and current_price < target_price * 1.1: # need some work on buying and selling condition
            if target_price < current_price and rating > x:
